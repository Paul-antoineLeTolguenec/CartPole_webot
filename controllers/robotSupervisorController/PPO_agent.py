...
class PPOAgent:
    ...
    def __init__(self, numberOfInputs, numberOfActorOutputs, clip_param=0.2, max_grad_norm=0.5, ppo_update_iters=8,
                 batch_size=64, gamma=0.99, use_cuda=False, actor_lr=0.0005, critic_lr=0.001, seed=None):
        super().__init__()
        if seed is not None:
            manual_seed(seed)
